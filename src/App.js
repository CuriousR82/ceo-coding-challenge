...
function App() {
  ...
  // Sets data as first, second, or third
                  ...
                  {isOpen && (
                    <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
                      <div className="py-1 rounded-md bg-white shadow-xs">
                        {options.map(option => (
                          <DropdownOption text={option.value} handleOptionClick={handleOptionClick} />
                        ))}
                      </div>
                    </div>
                  )}
